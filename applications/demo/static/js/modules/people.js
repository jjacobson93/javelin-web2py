...
function loadRecord(id) {
	$.ajax({
		type: "POST",
		url: "/demo/people/call/json/record",
		data: {
			'id' : id
		},
		dataType: "json",
...
function loadSchedule(id) {
	$.ajax({
		type: 'POST',
		url: '/demo/people/call/json/schedule',
		data: {
			'id': id
		},
		dataType: 'json',
...
function saveChanges(toPrev) {
	...
	$.ajax({
		type: "POST",
		url: "/demo/people/call/json/update_record",
		data: {
			'id' : id,
...
function updatePic(id, pic) {
	$.ajax({
		type: "POST",
		url: "/demo/people/call/json/update_pic",
		data: {
			"id" : id,
			"pic" : pic
		},
...
$(function() {
	var peopleTable = $('#people-table').jTable({
		...
		ajax: {
			source: '/demo/people/call/json/data',
			error: function() {
