...
(function($)
{
	$.widget("awnry.pickList",
	{
		options:
		{
			...
			controlsContainerClass:     "pickList_controlsContainer btn-group btn-group-vertical",
			...
			// Control classes
			addAllClass:                "btn pickList_addAll",
			addClass:                   "btn pickList_add",
			removeAllClass:             "btn pickList_removeAll",
			removeClass:                "btn pickList_remove",
		...
		_buildControls: function()
		{
			...
			self.addAllButton.css("padding", "4px");
			self.addButton.css("padding", "4px");
			self.removeButton.css("padding", "4px");
			self.removeAllButton.css("padding", "4px");
